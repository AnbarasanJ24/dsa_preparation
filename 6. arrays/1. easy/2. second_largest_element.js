...
//  In case of negative number, take Number.MIN_SAFE_INTEGER;

const secondLargest_brute = ()=>{
  arr1.sort((a, b) => a - b);
...
// Here first element other than largest is second largest, second element other than largest is third largest - without duplicates

// console.log("Brute - second largest", secondLargest_brute(arr));
